...
$sql = "SELECT * FROM biodata ORDER BY id_biodata ASC";  // Make sure 'id_biodata' is correct
$result = $conn->query($sql);

// Check if the query was successful
if ($result === false) {
    echo "Error in SQL query: " . $conn->error;  // Display the SQL error message
} else {
...
?>
      <tr>  
        ...
        onclick='confirm("Apakah Anda yakin ingin menghapus data ini?")'>Hapus</a>  
        </td>  
      </tr>  
<?php
        }
